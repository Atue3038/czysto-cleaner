...
export const t = {
  RU: {
    ...
    advantages: {
      ...
      cards: [
        { title: "VIP уровень обслуживания",        text: "Премиальный подход к каждой детали, аккуратная и бережная работа, а главное — результат, близкий к идеалу" },
        ...
        { title: "Работаем с дорогой мебелью",          text: "Бережный уход за деликатными тканями, мягкой мебелью и коврами, что избавляет Вас от любых волнений за Вашу фурнитуру" },
      ],
    },
  ...
  PL: {
    ...
    advantages: {
      title: "Nasze zalety",
      cards: [
        { title: "Obsługa na poziomie VIP",          text: "Premiumowe podejście do każdego szczegółu, staranna i delikatna praca, a przede wszystkim — wynik bliski ideału" },
        ...
        { title: "Czyścimy do skutku",                text: "Bez ograniczeń czasowych — pracujemy, aż będzie idealnie, <strong>bez żadnych dopłat</strong> z Państwa strony" },
        { title: "Pracujemy z drogimi meblami",       text: "Delikatna pielęgnacja delikatnych tkanin, mebli tapicerowanych i dywanów, co uwalnia Państwa od wszelkich obaw o okucia" },
      ],
    },
  ...
  ENG: {
    ...
    advantages: {
      ...
      cards: [
        { title: "VIP level service",                  text: "A premium approach to every detail, careful and delicate work, and most importantly — a result close to perfection" },
        ...
        { title: "We clean until perfect",             text: "No time limits — we work until perfect, <strong>with no additional charges</strong> on Your part" },
        { title: "We work with expensive furniture",   text: "Gentle care for delicate fabrics, upholstered furniture and carpets, freeing You from any concerns about Your fittings" },
      ],
    },
